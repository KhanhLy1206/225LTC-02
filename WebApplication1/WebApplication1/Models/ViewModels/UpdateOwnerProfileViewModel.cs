...
{
    public class UpdateOwnerProfileViewModel
    {
        [Required(ErrorMessage = "Tên chủ bãi không được để trống.")]
        [StringLength(100, ErrorMessage = "Tên chủ bãi không vượt quá 100 ký tự.")]
